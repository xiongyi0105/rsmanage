...
SECRET_KEY = 'django-insecure-l(y6wd5x1(7&teb&lb@fx9dggb$_p+yypad3&-@)720@1^lyrb'
...
INSTALLED_APPS = [
    ...
    'rest_framework',  # pip install djangorestframework, markdown, django-filter
...
# import_export model permission code
